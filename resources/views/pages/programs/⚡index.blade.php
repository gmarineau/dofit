...
<div>
    ...
    @forelse ($this->programs as $program)
        ...
        <li wire:key="program-{{ $program->id }}" class="flex items-center gap-3 border-b border-line last:border-0">
        ...
        @if ($loop->last)
            ...
            <x-add-row class="mt-4" :href="route('programs.create')" wire:navigate :label="__('Add a program')" />
        @endif
    @empty
